...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(30, 0, 30,
            18);
     ...
     * inches.
     */
    public static double MAX_VEL = 95; //98 from maxVelocityTuner
